...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isi: Schema.Attribute.RichText & Schema.Attribute.Required;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    haloHeader: Schema.Attribute.String & Schema.Attribute.Required;
    job: Schema.Attribute.String & Schema.Attribute.Required;
    kontak: Schema.Attribute.RichText & Schema.Attribute.Required;
    kontakHeader: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    projek: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    riwayatPekerjaanHeader: Schema.Attribute.String & Schema.Attribute.Required;
    riwayatProjek: Schema.Attribute.String;
    tentangSaya: Schema.Attribute.RichText & Schema.Attribute.Required;
    tentangSayaHeader: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dari: Schema.Attribute.Date & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    namaPerusahaan: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sampai: Schema.Attribute.Date;
    tautan: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjectToolProjectTool extends Struct.CollectionTypeSchema {
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deskripsiPanjang: Schema.Attribute.Text & Schema.Attribute.Required;
    deskripsiSingkat: Schema.Attribute.Text & Schema.Attribute.Required;
    gambarProjek: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    judul: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    project_platform: Schema.Attribute.Relation<
      'manyToOne',
      'api::project-platform.project-platform'
    >;
    project_tools: Schema.Attribute.Relation<
      'manyToMany',
      'api::project-tool.project-tool'
    >;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    tautan: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waktuMulaiDevelop: Schema.Attribute.Date & Schema.Attribute.Required;
    waktuSelesaiDevelop: Schema.Attribute.Date & Schema.Attribute.Required;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::project-tool.project-tool': ApiProjectToolProjectTool;
